...
*/
export default function Weather(args: any) {
        ...
        <>
            <div className="flex flex-col items-center justify-center">
                <div className="flex flex-col items-center justify-center">
                    ...
                    {current && <>
                        <h2 className="text-xl font-semibold">{current.temperature} {current.format}</h2>
                    ...
                    <div className="flex flex-row items-center justify-center">
                        {forecast.map((day, index) => (
                            <div key={`forecast-${index}`} className="flex flex-col items-center justify-center">
                                ...
                                <h3 className="text-lg font-semibold">{day.temperature} {day.format}</h3>
                ...
                {precipitation && (
                    <div className="flex flex-row items-center justify-center">
                        {precipitation.map((percent, index) => (
